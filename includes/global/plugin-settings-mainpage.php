...
function wts_clp_plugin_register_settings() {
	...
	register_setting( 'wts_clp_options_group', 'wts_clp_text_or_image_aslogo', 'myplugin_callback' );
	register_setting( 'wts_clp_options_group', 'wts_clp_text_aslogo', 'myplugin_callback' );
